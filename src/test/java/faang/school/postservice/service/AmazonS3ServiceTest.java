...
public class AmazonS3ServiceTest {
    ...
    void uploadFileImageCompressionAppliedTest() throws IOException {
        ...
        verify(imageCompressionService, times(1)).compressImage(originFileBytes, fileData.getExtension());
    ...
    void deleteFileSuccessfulTest() {
        ...
        verify(amazonS3Client, times(1)).deleteObject(Mockito.anyString(), Mockito.eq(fileKey));
    }
