...
public class PostFileValidator {
    ...
    private void validateFileExtension(FileData fileData) {
        Map<String, PostFileUploadProperties.FileTypeInfo> infoByFileType = postFileUploadProperties.getInfoByFileType();
        PostFileUploadProperties.FileTypeInfo fileTypeInfo = infoByFileType.getOrDefault(fileData.getType(), infoByFileType.get("another"));
