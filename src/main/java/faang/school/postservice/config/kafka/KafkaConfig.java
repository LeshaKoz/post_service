...
public class KafkaConfig {
    ...
    @Value("${spring.data.kafka.address}")
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, AbstractKafkaEventDto>
    kafkaListenerContainerFactory() {

        ConcurrentKafkaListenerContainerFactory<String, AbstractKafkaEventDto> factory =
